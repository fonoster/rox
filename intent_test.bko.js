...
async function testIntent(text) {
  ...
  const results = await sessionClient.detectIntent(request1)
  ...
  await sessionClient.detectIntent(request2)

  return await sessionClient.detectIntent(request3)
}

testIntent("I want the menu")
